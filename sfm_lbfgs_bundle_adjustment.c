...
/*
Image measurements are never modified!
*/
 ...
 */
 ...
 /*
 Constrain camera 0
 which is always assumed to correspond to the world coordinates
 */
 ...
 */
 ...
 /*
 Force a camera to have some arbitrary orientation/position
 for debugging
 */

 /*
 camera_matrix_ind= 1;
 p_camera_arr[camera_matrix_ind*6+0]= 0;
 p_camera_arr[camera_matrix_ind*6+1]= 1;
 p_camera_arr[camera_matrix_ind*6+2]= 2;
 p_camera_arr[camera_matrix_ind*6+3+0]= 3;
 p_camera_arr[camera_matrix_ind*6+3+1]= 4; 
 p_camera_arr[camera_matrix_ind*6+3+2]= 5;
 */

 /*
 Force a point to be at some arbitrary coords
 for debugging
 */

 /*
 threedpoint_ind= 0;
 p_point_arr[threedpoint_ind*3+0]= 0;
 p_point_arr[threedpoint_ind*3+1]= 1;
 p_point_arr[threedpoint_ind*3+2]= 2;
 */
 ...
 */
 ...
 /*
 Update the points and the measurements
 */
 ...
 for ( threedpoint_ind= 0 ;
    ...
    */
    ...
    for ( imagepoint_ind= 0 ;
       ...
       camera_ind2= measurement_arr[measurement_ind].camera_ind;
       threedpoint_ind2= measurement_arr[measurement_ind].point_ind;
       x2= measurement_arr[measurement_ind].x3[0];
       y2= measurement_arr[measurement_ind].x3[1];
       z2= measurement_arr[measurement_ind].x3[2];

       if ( camera_ind2 != camera_matrix_ind ) {
          sfm10_error_handler("sfm_lbfgs_bundle_adjustment");
       }
       if ( threedpoint_ind2 != threedpoint_ind ) {
          sfm10_error_handler("sfm_lbfgs_bundle_adjustment");
       }
       if ( x2 != x ) {
          sfm10_error_handler("sfm_lbfgs_bundle_adjustment");
